...
public class NewUfoSightingsController {
	...
	void doCreaGrafo(ActionEvent event) {
		...
		if (forma == null || flag==false)
		{
			txtResult.appendText("ERRORE: selezionare una forma\n");
			return;
		}
		
		if(flag==true)
		{String ris= model.creaGrafo(forma);
	...
	void doSelezionaAnno(ActionEvent event) {
		...
		}catch(NumberFormatException n) {txtResult.appendText("Errore nel formato: inserire solo numeri\n");
											return;}

		if (anno<1910 || anno>2014)
		{
			txtResult.appendText("ERRORE: l'anno inserito è troppo alto o troppo basso\n");
			return;
		}
